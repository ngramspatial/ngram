    ...
    def command(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        if command == "capabilities":
            ...
            return {"ok": True, "protocol": PROTOCOL, "installed": bool(executable),
                    ...
                    "size:256..1536, samples:1..256, style:scene|studio|clay, projection:perspective|orthographic|equirectangular}. "
                    "Equirectangular renders a full 360-degree 2:1 panorama with style=scene, size up to 4096 (default 2048). "
                    "Set position to the viewer location and look_at to a forward point; default [0,0,1.6] looking toward [0,1,1.6]. "
                    "Empty scenes with only a World shader are supported. The returned skybox can be applied with ar_environment configure. "
